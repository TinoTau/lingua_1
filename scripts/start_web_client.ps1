...
# Updated path: web-client is now in webapp/web-client
$webClientPath = Join-Path $projectRoot "webapp" "web-client"
...
Write-Host "Project path: $webClientPath" -ForegroundColor Gray
Write-Host "Logs will be saved to: $logDir\web-client.log" -ForegroundColor Gray
Write-Host "Service URL: http://localhost:9001" -ForegroundColor Gray
