...
**项目状态**:
- ✅ 阶段 2.1：核心功能已完成（包含单元测试）
- ✅ 阶段 2.1.2：ASR 字幕 ✅（已完成，包含单元测试）
- ⏸️ 阶段 2.1.3：Utterance Group（需要后端支持）
...
详细设计请参考 [对外开放 API 文档](./api_gateway/PUBLIC_API.md)
...
详细设计请参考 [模块化功能设计文档](./modular/MODULAR_FEATURES.md)
