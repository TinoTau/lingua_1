...
详细 API 文档请参考 [对外开放 API 文档](./api_gateway/PUBLIC_API.md)
...
- 查看 [模块化功能设计](./modular/MODULAR_FEATURES.md) 了解可选功能模块（文档开头包含快速参考）
- 查看 [协议规范](./PROTOCOLS.md) 了解 WebSocket 消息协议
- 查看 [对外开放 API 文档](./api_gateway/PUBLIC_API.md) 了解对外 API 设计
