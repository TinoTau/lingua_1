# Pinyin-IME-V1 Rename and Three-Layer Dictionary Freeze Plan V1.1 Supplement

版本：V1.1 Supplement
日期：2026-06-03

说明：
- 本文档为《Pinyin-IME-V1 Rename & Three-Layer Dictionary Freeze Plan》的补充约束文档。
- 本文档来源于开发前审计与补充清单。
- 本文档优先级高于 Spike 临时实现习惯。
- 不允许突破 Lexicon V3.1、FW、Patch Service、Scheduler 冻结合约。
- pinyin-ime-v1 仍为离线 Spike，不进入主链。
