...
export type AsrRepairQualityConfig = {
...
export type AsrRepairQualityConfigSnapshot = {
  allowedWindowLengths: number[];
  topKByTermLength: Record<string, number>;
  maxActiveWindows: number;
  maxSentenceCandidates: number;
...
export function resolveAsrRepairQualityConfig(
  nodeConfig: NodeConfig | null | undefined = loadNodeConfig()
): AsrRepairQualityConfig {
...
export function getAsrRepairQualityConfig(): AsrRepairQualityConfig {
  return resolveAsrRepairQualityConfig(loadNodeConfig());
}

export function buildAsrRepairQualityConfigSnapshot(
  cfg: AsrRepairQualityConfig = getAsrRepairQualityConfig()
): AsrRepairQualityConfigSnapshot {
  return {
