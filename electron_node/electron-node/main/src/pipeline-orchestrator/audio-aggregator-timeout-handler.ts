...
export interface TimeoutSplitResult {
  firstHalf: Buffer;
  secondHalf: Buffer;
  shouldKeepBuffer: boolean;
}

/**
 * 处理超时切割
 */
export function handleTimeoutSplit(
  ...
  splitHangoverMs: number,
  secondarySplitThresholdMs: number,
  nowMs: number
): TimeoutSplitResult | null {
