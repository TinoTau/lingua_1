...
import { OriginalJobInfo, JobContainer } from './audio-aggregator-types';

export class AudioAggregatorJobContainer {
   ...
   * @returns Job容器数组
   */
  buildContainers(jobInfo: OriginalJobInfo[]): JobContainer[] {
   ...
   */
  assignOriginalJobIdsForBatches(
    batches: Buffer[],
  ...
  assignOriginalJobIds(
    ...
    for (const segment of audioSegments) {
      ...
      let assignedJobId: string | undefined = undefined;
