...
interface PauseMergeResult {
  shouldMerge: boolean;
  mergedAudio?: Buffer;
  mergedJobInfo?: OriginalJobInfo[];
  shouldCache: boolean;
}

export class AudioAggregatorPauseHandler {
  private readonly SHORT_AUDIO_THRESHOLD_MS = 1000; // 短音频阈值：1秒
  private readonly PAUSE_MERGE_TTL_MS = 5000; // pause音频合并TTL：5秒
