...
exports.detectHomophoneErrors = detectHomophoneErrors;
exports.hasPossibleHomophoneErrors = hasPossibleHomophoneErrors;
const homophone_learner_1 = require("./homophone-learner");
/**
 ...
 * 获取所有同音字错误模式（手动 + 自动学习）
 */
function getAllHomophoneErrors() {
    // 合并手动维护和自动学习的模式
    const learned = (0, homophone_learner_1.getLearnedPatterns)();
    return {
 ...
 * @returns 是否可能包含同音字错误
 */
function hasPossibleHomophoneErrors(text) {
    const allErrors = getAllHomophoneErrors();
