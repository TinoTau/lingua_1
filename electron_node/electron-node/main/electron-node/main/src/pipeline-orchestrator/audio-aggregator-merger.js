...
exports.AudioAggregatorMerger = void 0;
const logger_1 = __importDefault(require("../logger"));
class AudioAggregatorMerger {
    constructor() {
     ...
     */
    cleanupOldBuffers(buffers, sessionId, reasonLog) {
        const now = Date.now();
...
exports.AudioAggregatorMerger = AudioAggregatorMerger;
