...
exports.PipelineOrchestratorAudioProcessor = void 0;
const logger_1 = __importDefault(require("../logger"));
class PipelineOrchestratorAudioProcessor {
    constructor(audioAggregator) {
        this.audioAggregator = audioAggregator;
    }
    /**
     * 处理音频：聚合和格式转换
     */
...
exports.PipelineOrchestratorAudioProcessor = PipelineOrchestratorAudioProcessor;
