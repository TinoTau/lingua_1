...
exports.AudioAggregatorStreamBatcher = void 0;
class AudioAggregatorStreamBatcher {
    constructor() {
    ...
    createStreamingBatchesWithPending(audioSegments, jobInfo, shouldCacheRemaining = true) {
        ...
        // 处理最后一个批次
        let remainingSmallSegments = [];
        let remainingSmallSegmentsJobInfo = [];
        if (currentBatch.length > 0) {
...
exports.AudioAggregatorStreamBatcher = AudioAggregatorStreamBatcher;
