...
class ASRRerunHandler {
     ...
     * 执行 Top-2 语言重跑
     */
    async executeRerun(task, asrResult, badSegmentDetection, audioDurationMs, httpClient, requestBody, previousText) {
...
exports.ASRRerunHandler = ASRRerunHandler;
