...
exports.findProjectPaths = findProjectPaths;
...
function findProjectPaths() {
    ...
    for (const candidate of uniqueCandidates) {
        ...
        if (fs.existsSync(nodeInferencePath)) {
            ...
            const servicePath = path.join(projectRoot, 'electron_node', 'services', 'node-inference', 'target', 'release', 'inference-service.exe');
