...
const report = JSON.parse(
  fs.readFileSync(path.join(__dirname, 'lexicon-cleanup-dialog200-batch-result.json'), 'utf8')
);
...
let improved = 0;
let degraded = 0;
const samples = { exact: [], fwApplied: [], worst: [] };
...
const outPath = path.join(__dirname, 'lexicon-cleanup-dialog200-quality-perf.json');
