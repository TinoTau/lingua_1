...
exports.runAllTestVectors = runAllTestVectors;
...
function runTestVector(vector) {
    try {
        ...
        manager.processUtterance(sessionId, vector.prev.text, prevSegments, vector.prev.lang, vector.prev.quality_score, vector.prev.is_final, vector.prev.is_manual_cut, vector.mode);
        // 处理第二个 utterance
        const currSegments = [
            {
        ...
        const result = manager.processUtterance(sessionId, vector.curr.text, currSegments, vector.curr.lang, vector.curr.quality_score, vector.curr.is_final, vector.curr.is_manual_cut, vector.mode);
