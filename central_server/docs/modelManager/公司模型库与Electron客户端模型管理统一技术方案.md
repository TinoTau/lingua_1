...
- [平台化方案可行性评估（归档）](./_archive/PLATFORM_READY_SPEC_FEASIBILITY_ASSESSMENT.md)
- [平台化契约版规范（归档）](./_archive/Platform_Ready_Model_Management_and_Node_Service_Package_Spec.md)

> 注：本文档的 v2/v3 检查清单内容已合并进正文，不再单独维护独立文件，避免重复与断链。
