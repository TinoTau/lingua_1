...
async fn test_select_node_with_features() {
    ...
    registry.update_node_heartbeat("node-en-zh", 10.0, Some(0.0), 10.0, None, None, 1, None, None, None).await;

    let selected = registry.select_node_with_features("zh", "en", &None, true).await;
    assert_eq!(selected, Some("node-zh-en".to_string()));

    registry.update_node_heartbeat("node-zh-en", 10.0, Some(0.0), 10.0, None, None, 2, None, None, None).await;
    registry.update_node_heartbeat("node-en-zh", 10.0, Some(0.0), 10.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_least_connections() {
    ...
    registry.update_node_heartbeat("node-heavy", 20.0, None, 20.0, None, None, 3, None, None, None).await;
    registry.update_node_heartbeat("node-medium", 20.0, None, 20.0, None, None, 1, None, None, None).await;
    registry.update_node_heartbeat("node-light", 20.0, None, 20.0, None, None, 0, None, None, None).await;
    ...
    // 娉ㄦ剰锛氳祫婧愪娇鐢ㄧ巼闇€瑕佷綆浜庨槇鍊硷紙榛樿 25%锛夛紝鎵€浠ヨ缃负 20%
    registry.update_node_heartbeat("node-heavy", 20.0, None, 20.0, None, None, 2, None, None, None).await;
    registry.update_node_heartbeat("node-light", 20.0, None, 20.0, None, None, 2, None, None, None).await;
...
async fn test_select_node_resource_threshold_cpu() {
    ...
    registry.update_node_heartbeat("node-low-cpu", 20.0, None, 15.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_resource_threshold_gpu() {
    ...
    registry.update_node_heartbeat("node-low-gpu", 15.0, Some(20.0), 15.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_resource_threshold_memory() {
    ...
    registry.update_node_heartbeat("node-low-mem", 15.0, None, 20.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_resource_threshold_all_resources() {
    ...
    registry.update_node_heartbeat("node-ok", 20.0, Some(20.0), 20.0, None, None, 0, None, None, None).await;
    // node-high-cpu: CPU 超过阈值
    registry.update_node_heartbeat("node-high-cpu", 30.0, Some(20.0), 20.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_resource_threshold_no_available() {
    ...
    registry.update_node_heartbeat("node-overloaded", 30.0, Some(30.0), 30.0, None, None, 0, None, None, None).await;
...
async fn test_select_node_resource_threshold_custom_threshold() {
    ...
    registry.update_node_heartbeat("node-60", 60.0, None, 60.0, None, None, 0, None, None, None).await;
