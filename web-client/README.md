...
- ✅ **功能选择**：用户可选择需要的可选功能（情感检测、音色识别、语速检测等）
...
2. **选择功能**：在连接前，可以选择需要的可选功能（情感检测、音色识别、语速检测等）
3. **开始录音**：点击"开始录音"按钮，开始说话
4. **结束本轮**：点击"结束本轮 (Send)"按钮，或等待静音自动结束
5. **查看结果**：等待翻译结果和 TTS 播放
...
- **音色风格检测**：检测语音的音色风格
- **语速检测**：检测语音的语速
- **语速控制**：控制输出语音的语速（需要先启用语速检测）
- **音色识别**：识别说话人的音色
- **个性化适配**：根据用户个性化需求适配翻译结果
